...
const ViewBookDetails = () => {
        ...
        useEffect(() => {
            ...
            const fetch = async () => {
                const response = await axios.get(`https://bookstore-mern-backend-ez6a.onrender.com/api/v1/get-book-by-id/${id}`);
        ...
        const handleFavourite = async() => {
            const response= await axios.put("https://bookstore-mern-backend-ez6a.onrender.com/api/v1/add-book-to-favourite",{},{ headers });
            alert(response.data.message);
        };

        const handleCart = async() => {
            const response= await axios.put("https://bookstore-mern-backend-ez6a.onrender.com/api/v1/add-to-cart",{},{ headers });
            alert(response.data.message);
        };
        const deleteBook = async() => {
            const response=await axios.delete("https://bookstore-mern-backend-ez6a.onrender.com/api/v1/delete-book",{headers});    
            alert(response.data.message);
            navigate("/all-books");
        };
