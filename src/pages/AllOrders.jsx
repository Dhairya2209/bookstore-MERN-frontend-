...
const AllOrders = () => {
  ...
  useEffect(() => {
    const fetch = async ()=> {
      const response = await axios.get(
        "https://bookstore-mern-backend-ez6a.onrender.com/api/v1/get-all-orders",
        {headers}
      );
  ...
  const submitChanges = async (i) => {
    ...
    const response = await axios.put(`https://bookstore-mern-backend-ez6a.onrender.com/api/v1/update-status/${id}`,
      Values,
      {headers}
    );
